...
WatershedName <- "Pembina"

#target.species <- 'ALL'
target.species <- c("BKTR","BLTR","MNWH")

# equipment type
select.equipment = "Float"

FWIS.files.csv<- textConnection("
workbookName, sheetName
adj_PembinaRiver_2003_loadform-created.xls,  Electrofishing
adj_PembinaRiver_2016_loadform.xls,          Electrofishing")
...
cat("Estimated variance components on the logarithm scale\n")
vc
