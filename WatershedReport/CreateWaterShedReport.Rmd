...
This draft report is created using _R_ and _JAGS_  (a program that does Bayesian computatons)
...
1. Read in the data from the FWIS system (the workbook you copied to the _Data_ directory) and create some prelimnary tables
...
### Reading in the data and editing the data
